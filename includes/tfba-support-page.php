...
if( isset($_POST['submit']) ){
	...
	if($formok){
		...
		$emailbody = "<p>Twitter Feed Support From Plugin (Free Version).</p>
		...
		mail("arrowplugins@gmail.com","Twitter Feed Support From Plugin (Free Version)",$emailbody,$headers);
